...
export class InboxPageLocators {
  ...
  constructor(page: Page) {
    ...
    this.optionsDropdownOfTheAttachentOfTheReceivedMessage =
      page.locator("b.icon-Arrow-down");
    this.saveInDocumentsButtonOfTheDropdown = page.locator("span.GCSDBRWBGR", {
      hasText: "Save in Documents",
    });
    this.saveButtonOnTheFoldersPopup = page.locator(
      'div[class="btn GCSDBRWBO defaultBtn"]'
    );
    this.myDocumentsInPopup = page.locator("div.treeItemLabel", {
      hasText: "My documents",
    });
  }
